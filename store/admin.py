...
class CustomerAdmin(admin.ModelAdmin):
    # for some reason the list_display is not working with user__first_name and user__last_name
    # so I had to define the list_display as a function in models.py
